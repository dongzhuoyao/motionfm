...
class Text2MotionDatasetV2(data.Dataset):
    def __init__(self, opt, mean, std, split_file, w_vectorizer):
        ...
        print(f"even shit happens, we have {len(length_list)} length_list")
...
class HumanML3D(data.Dataset):
    def __init__(
        ...
        **kwargs,
        ...
        self.dataset_name = self.dataname = "t2m"
    ...
    def __getitem__(self, id):
        return self.t2m_dataset.__getitem__(id)
