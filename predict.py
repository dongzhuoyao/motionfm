...
from generate import construct_template_variables
...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        rot2xyz_pose_rep = (
            "xyz" if self.model.data_rep in ["xyz", "hml_vec"] else self.model.data_rep
        )
        rot2xyz_mask = (
            None
            if rot2xyz_pose_rep == "xyz"
            else model_kwargs["y"]["mask"]
            .reshape(args.num_repetitions, self.num_frames)
            .bool()
        )
