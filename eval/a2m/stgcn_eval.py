...
def evaluate(args, model, dynamic, data, cfg=None):
    ...
    recogparameters["num_classes"] = args.num_classes
    ...
    for index, seed in enumerate(allseeds):
        ...
        genLoaders = {
            key: new_data_loader(mode="gen", dataiterator=dataiterator[key][0], cfg=cfg)
            for key in ["train", "test"]
        }
